...
const rolePermissions = {
    ...
    technician: [
        ...
        { name: "My Jobs Report", path: "/reports/api/jobs", icon: "📊", description: "View reports of your assigned jobs", color: "#f59e0b" },
        { name: "Leave Request", path: "/leave", icon: "🏖️", description: "Request time off work", color: "#F59E0B" },
    ],
    manager: [
        ...
        { name: "Users Report", path: "/reports/api/users", icon: "👥", description: "Generate comprehensive user accounts and role reports", color: "#EC4899" },
