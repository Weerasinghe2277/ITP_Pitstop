...
// My created jobs route (for service advisors to see jobs they created)
router.get("/my-created-jobs", authenticate, authorize("service_advisor", "manager", "admin"), getMyCreatedJobs);
